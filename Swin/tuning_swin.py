...
if __name__ == '__main__':
    # Example run
    train_swin_variant(transform_base, config_base, "swin_base_config.pth")
    train_swin_variant(transform_base, config_change_lr, "swin_lr_config.pth")
    train_swin_variant(transform_base, config_change_batch, "swin_batch_config.pth")
    train_swin_variant(transform_base, config_change_all, "swin_all_config.pth")
    train_swin_variant(transform_augmented, config_base, "swin_augmented_config.pth")